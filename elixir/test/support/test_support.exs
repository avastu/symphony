defmodule SymphonyElixir.TestSupport do
  ...
  def stop_default_http_server do
    with pid when is_pid(pid) <- Process.whereis(SymphonyElixir.Supervisor),
      ...
      :ok = Supervisor.terminate_child(pid, SymphonyElixir.HttpServer)
  ...
  defp workflow_content(overrides) do
    config =
      Keyword.merge(
        [
          ...
          tracker_continuation_states: ["Todo", "In Progress", "Rework", "Merging"],
    ...
    tracker_managed_projects = Keyword.get(config, :tracker_managed_projects)
    ...
    sections =
      [
        ...
        "  managed_projects: #{yaml_value(tracker_managed_projects)}",
